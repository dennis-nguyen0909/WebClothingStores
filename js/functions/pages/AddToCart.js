...
function addToCart(product) {
  ...
  var productHTML = '<div class="itemcart"><p class="productname">' + product.name + '</p><p class="productprice">' + product.price + '</p><p class="productquantity">' + product.quantity + '</p></div>';
