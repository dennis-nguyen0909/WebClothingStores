...
function renderListProductsPageSale(){
    ...
    for(let i=0;i < productSale.length;i++){
        ...
        <div class="product-shirt-noibat">
            <a class="product-shirt-a" href="">
                 <img class="product-shirt-1 "src="${[productSale[i].avatar]}" alt="MatSau">
                <img class="product-shirt-2 "src="${[productSale[i].avatar2]}" alt="MatTruoc">
            </a>
            <div class="product-shirt-price">
                <h1 class="product-shirt-title">${[productSale[i].productName]}</h1>
...
function renderListProductPants(){
    ...
    for(let i=0;i< productPants.length;i++){
        ...
        <div class="product-shirt-noibat">
            <a class="product-shirt-a" href="">
                 <img class="product-shirt-1 "src="${[productPants[i].avatar]}" alt="MatSau">
                <img class="product-shirt-2 "src="${[productPants[i].avatar2]}" alt="MatTruoc">
            </a>
            <div class="product-shirt-price">
                <h1 class="product-shirt-title">${[productPants[i].productName]}</h1>
...
function renderListProductPantsLong(){
    ...
    for ( let i=0;i<productPantsLong.length;i++){
        ...
        <div class="product-shirt-noibat">
            <a class="product-shirt-a" href="">
                <img class="product-shirt-1 "src="${[productPantsLong[i].avatar]}" alt="MatSau">
                <img class="product-shirt-2 "src="${[productPantsLong[i].avatar2]}" alt="MatTruoc">
            </a>
            <div class="product-shirt-price">
                <h1 class="product-shirt-title">${[productPantsLong[i].productName]}</h1>
                <p class="product-shirt-title ">${[productPantsLong[i].price]}</p>
            </div>
        </div>
        `
...
function renderListProductsBalo(){
    ...
    for ( let i=0;i<productBalo.length;i++){
        ...
        <div class="product-shirt-noibat">
            <a class="product-shirt-a" href="">
                <img class="product-shirt-1 "src="${[productBalo[i].avatar]}" alt="MatSau">
                <img class="product-shirt-2 "src="${[productBalo[i].avatar2]}" alt="MatTruoc">
            </a>
            <div class="product-shirt-price">
                <h1 class="product-shirt-title">${[productBalo[i].productName]}</h1>
    ...
    for ( let i=0;i<productIndex.length;i++){
        ...
        <div class="product-shirt-noibat">
            <a class="product-shirt-a" href="">
                ...
                <img class="product-shirt-2 "src="${[productIndex[i].avatar2]}" alt="MatTruoc">
            </a>
            <div class="product-shirt-price">
                <h1 class="product-shirt-title">${[productIndex[i].productName]}</h1>
...
function renderListProductAccessory(){
    ...
    for ( let i=0;i<productAccessory.length;i++){
        ...
        <div class="product-shirt-noibat">
            <a class="product-shirt-a" href="">
                <img class="product-shirt-1 "src="${[productAccessory[i].avatar]}" alt="MatSau">
                <img class="product-shirt-2 "src="${[productAccessory[i].avatar2]}" alt="MatTruoc">
            </a>
            <div class="product-shirt-price">
                <h1 class="product-shirt-title">${[productAccessory[i].productName]}</h1>
                <p class="product-shirt-title ">${[productAccessory[i].price]}</p>
            </div>
        </div>
        `
